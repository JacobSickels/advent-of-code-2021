...
(def image (core/read-file "resources/day_20.txt"))
(def enhancement (core/load-edn "day_20_enhancement.edn"))

(def image_p (map #(map str %) (core/load-edn "day_20.edn")))
(def enhancement_p (core/load-edn "day_20_enhancement_p.edn"))
